...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder ".", "/go/src/github.com/raj-sh-git/kaniko-revanced"
  config.ssh.extra_args = ["-t", "cd /go/src/github.com/raj-sh-git/kaniko-revanced; bash --login"]
